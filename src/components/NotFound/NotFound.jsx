...
const NotFound = () => {
  return (
    <div className={clsx(style.not_found)}>
      <nav>
        <div className={clsx(style.menu)}>
          <Link to="/" className={clsx(style.website_name)}>
            <svg
      ...
      <section className={clsx(style.wrapper)}>
        <div className={clsx(style.container)}>
          <div id="scene" className={clsx(style.scene)} data-hover-only="false">
            <div className={clsx(style.circle)} data-depth="1.2"></div>

            <div className={clsx(style.one)} data-depth="0.9">
              <div className={clsx(style.content)}>
                <span className={clsx(style.piece)}></span>
                <span className={clsx(style.piece)}></span>
                <span className={clsx(style.piece)}></span>
              </div>
            </div>

            <div className={clsx(style.two)} data-depth="0.60">
              <div className={clsx(style.content)}>
                <span className={clsx(style.piece)}></span>
                <span className={clsx(style.piece)}></span>
                <span className={clsx(style.piece)}></span>
            ...
            <div className={clsx(style.three)} data-depth="0.40">
              <div className={clsx(style.content)}>
                <span className={clsx(style.piece)}></span>
                <span className={clsx(style.piece)}></span>
                <span className={clsx(style.piece)}></span>
            ...
            <p className={clsx(style.p404)} data-depth="0.50">
              404
            </p>
            <p className={clsx(style.p404)} data-depth="0.10">
              404
            </p>
          </div>
          ...
          <div className={clsx(style.text)}>
            <article>
              ...
              <Link className={clsx(style.not_found_home)} to="/">
                Go Home
              </Link>
            </article>
          </div>
